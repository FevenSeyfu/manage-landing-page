...
const Home = () => {
  return (
    <div
      name="home"
      className="bg-[url('/src/assets/images/bg-tablet-pattern.svg')] h-screen w-full bg-no-repeat bg-auto bg-[right_-12rem_bottom_4rem] top-0 left-0"
    >
      <Navbar />
      <div className="flex flex-col lg:flex-row lg:justify-evenly lg:px-40 lg:py-10">
        ...
        <div>
          <img src="/src/assets/images/illustration-intro.svg" alt="Illustraion image" className="ml-12" />
        </div>
      </div>
    </div>
  );
